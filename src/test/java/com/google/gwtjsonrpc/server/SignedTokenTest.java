...
public class SignedTokenTest {
   ...
   */
  @Test
  public void checkTokenTest() throws XsrfException, InvalidTokenException {
  ...
  public void checkTokenInputTokenNullTest() throws XsrfException, InvalidTokenException {
    String token = signedToken.newToken(TEXT, true);
   ...
   */
  @Test(expected = InvalidTokenException.class)
  public void checkTokenInputTokenEmptyTest() throws XsrfException, InvalidTokenException {
    String token = signedToken.newToken(TEXT, true);
   ...
   */
  @Test(expected = InvalidTokenException.class)
  public void checkTokenInputTokenNoDollarSplitorTest()
   ...
   */
  @Test(expected = InvalidTokenException.class)
  public void checkTokenForgedKeyTest() throws XsrfException, InvalidTokenException {
    String token = signedToken.newToken(TEXT, true);
  ...
  public void checkTokenForgedTextTest()
      throws XsrfException, InvalidTokenException, InterruptedException {
    String token = signedToken.newToken(TEXT, true);
